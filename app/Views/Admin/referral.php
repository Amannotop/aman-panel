        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    <label for="set_saldo">Set Balace For Reseller</label>
                    <div class="input-group mt-2">
                        <span class="input-group-text"><span style='font-family:Arial;'>&#8377;</span></span>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-outline-info">Create Code</button>
                </div>
                <?= form_close() ?>
            </div>
        </div>
                            ...
                            <tbody>
                                <?php foreach ($code as $c) : ?>
                                    <tr>
                                        ...
                                        <td><span style='font-family:Arial;'>&#8377;</span><?= $c->set_saldo ?></td>
