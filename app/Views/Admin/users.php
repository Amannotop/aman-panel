...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-info text-white h6 p-3">
                Manage <?= $title ?>
            </div>
            <div class="card-body">
                <!-- <?php if ($user_list) : ?> -->
        ...
        var table = $('#datatable').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    data: 'saldo',
                    render: function(data, type, row, meta) {
                        var textc = (row.level === 'Admin' ? 'primary' : 'info');
                ...
                },
                {
                    data: null,
                    render: function(data, type, row, meta) {
                        return `<a href="${window.location.origin}/admin/user/${row.id}" class="btn btn-info btn-sm">EDIT</a>`;
                    }
                }
            ]
        });
