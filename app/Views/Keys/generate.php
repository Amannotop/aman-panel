        ...
        <?php if (session()->getFlashdata('user_key')) : ?>
            <div class="alert alert-success" role="alert">
                ...
                <small>
                    ...
                    <i class="bi bi-wallet"></i> Cost :
                    <span class="text-danger"><span style='font-family:Arial;'>&#8377;</span>-<?= session()->getFlashdata('fees') ?></span>
                    (Total Balance <span style='font-family:Arial;'>&#8377;</span><?= $user->saldo ?>)
                </small>
            </div>
        <?php endif; ?>
        <div class="card">
            <div class="card-header p3 bg-info text-white">
                <div class="row">
                    <div class="col pt-1">
                        Create License
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-lg-6 mb-3">
                        <label for="game" class="form-label">Type</label>
                ...
                <div class="form-group mb-3">
                    <label for="estimation" class="form-label">Deduction</label>
